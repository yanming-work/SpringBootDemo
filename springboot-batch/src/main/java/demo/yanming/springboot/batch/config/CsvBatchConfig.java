package demo.yanming.springboot.batch.config;

import demo.yanming.springboot.batch.csv.CsvBeanValidator;
import demo.yanming.springboot.batch.csv.CsvItemProcessor;
import demo.yanming.springboot.batch.csv.CsvJobListener;
import demo.yanming.springboot.batch.domain.Student;
 ...
 * Package Name:demo.yanming.springboot.batch.config <br/>

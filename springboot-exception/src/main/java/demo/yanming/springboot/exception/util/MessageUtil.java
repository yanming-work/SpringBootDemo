package demo.yanming.springboot.exception.util;
 ...
 * Package Name:demo.yanming.springboot.exception.util <br/>
...
public class MessageUtil {
    ...
    public static <E>Message<E> ok(E o){
        return new Message<E>(200, "success", o, new Date().getTime());
    }
